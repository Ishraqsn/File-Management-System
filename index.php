...
<div class="se-pre-con"></div>
	...
	<center>
	<br><br>
	<span style="color: #8bc34a;font-family: 'Josefin Sans', cursive; font-size: 4em;text-shadow: 1px 2px 3px #000;"><u>Welcome to File Trackin</u>g <u>S</u>y<u>stem</u></span><br><br>
	</center>
		<div class="row">
			<div class="col-sm-12">
				<div class="row">
							...
							<div class="col-sm-12">
								<div class="row">
									...
									<form action="code.php?act=1" method="post">
										...
										<a href="#" style="text-decoration: none; color: #fafafa">Forgot Password?</a><br
									</div>
									</form>
									<div class="col-sm-1">
